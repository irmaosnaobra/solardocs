  ...
  const agentes: AgenteCard[] = [
    ...
    },
    {
      ...
      toques: [
        ...
        { titulo: '📵 não atendeu: chamada de volta às 19h', quando: 'todo dia das 19h, só pra quem o CONSULTOR marcou', copy: 'O consultor esperou e a pessoa não veio. Em vez de ponto final, ela recebe o que está deixando na mesa (o estudo do ponto dela, com número), a informação de que o consultor a chamou, e três horários pra escolher. Responde o número e o robô remarca sozinho. Quem o ROBÔ marcou de ausente NÃO entra: ali ninguém chamou ninguém, e dizer que chamou seria mentira. Kill-switch EP_FUP_NAOATENDIDO_OFF.' },

      ...
      <div className="mx-auto flex max-w-[1240px] items-center gap-4 px-4 py-3">
        ...
        <form onSubmit={buscar} className="relative ml-auto w-full max-w-lg">
          ...
          <input
            ...
            className="h-11 w-full rounded-full border border-borda-forte bg-fundo pr-11 pl-4 text-sm text-tinta placeholder:text-fraco focus:border-acao focus:bg-white focus:outline-none"
          />
          <button
            type="submit"
            aria-label="Buscar"
            className="absolute top-0 right-0 flex h-11 w-11 items-center justify-center text-suave hover:text-acao"
          >

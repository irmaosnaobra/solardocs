...
const PUBLIC_PATHS = ['/lp/', '/auth', '/_api', '/limpar-cache', '/p/', '/v/', '/orc/', '/gerador', '/io', '/apresentacao', '/privacidade', '/exclusao-de-dados', '/simular', '/kit', '/dimensionamento', '/calculadora', '/inventario-empresarial', '/oferta', '/eletroposto', '/ponto-certo', '/plugcash', '/assinar', '/quase-la', '/pix-automatico', '/lib', '/bike', '/kilova', '/nexus', '/irmaosnaobra', '/robots.txt', '/sitemap.xml'];
